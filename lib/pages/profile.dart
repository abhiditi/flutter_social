...
import 'package:fluttersocial/pages/edit_profile.dart';
...
import 'package:fluttersocial/widgets/post_tile.dart';
...
class _ProfileState extends State<Profile> {
  ...
  Expanded buildButton({String text, Function function}) {
    return Expanded(
